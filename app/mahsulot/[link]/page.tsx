...
function MahsulotContent() {
  ...
  const [tanlangan_tolov, setTanlangan_tolov] = useState<"toliq" | number>("toliq")
  ...
  const keyingi_rasm = () => {
    if (!mahsulot) return
    const jami_rasmlar = mahsulot.rasmlar.length + mahsulot.ranglar.length
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="relative aspect-square bg-muted/20 rounded-xl overflow-hidden shadow-lg border border-border/50">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-foreground">{mahsulot.nom}</h1>
