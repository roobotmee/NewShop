...
export default function AdminLogin() {
  const [email, setEmail] = useState("admin@techstore.uz")
  const [parol, setParol] = useState("admin123")
        ...
        <CardContent className="space-y-4 sm:space-y-6">
          ...
          <form onSubmit={kirish} className="space-y-4">
            ...
            <div className="text-center text-xs sm:text-sm text-muted-foreground mt-4 space-y-1 p-4 bg-muted/30 rounded-lg border border-purple-500/10">
              <p className="font-medium">Default login ma'lumotlari:</p>
              <p>Email: admin@techstore.uz</p>
              <p>Parol: admin123</p>
            </div>
          </form>
        </CardContent>
